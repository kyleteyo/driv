...
def safe_initialize_missing_users():
    ...
    # DISABLED: This function was causing password resets during uploads
    # Users should be manually managed to prevent overwrites
    print("Safe user initialization disabled to prevent password resets")
    return True
